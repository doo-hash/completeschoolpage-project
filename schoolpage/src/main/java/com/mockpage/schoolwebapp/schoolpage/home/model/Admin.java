...
public class  Admin{
	...
	public Admin(
			...
			@Pattern(regexp = "^[a-zA-Z0-9_-]{2,40}", message = "Invalid Characters") @NotEmpty(message = "Admin Id cannot be empty") String adminId,
			...
			@NotBlank(message = "Passowrd cannot be empty") @Size(min = 8, max = 16, message = "password must be 8 to 16 characters length!") @Pattern(regexp = "^[a-zA-Z0-9_!#$%&*?`{|}~^-+/=’]+(?:\\.[a-zA-Z0-9_!#$%&’*+/=?`{|}~^-]+)*", message = "Invalid characters in password") String password,
